 #!/bin/bash
  ...
  NOME="AnyDesk"
  LINK="https://download.anydesk.com/linux/anydesk_6.2.1-1_amd64.deb"
  PACOTE="anydesk_6.2.1-1_amd64.deb"
  #####################################################################################
  #####################################################################################
(
...
zenity --password --title="Autenticação!" | sudo -S dpkg -i /tmp/$PACOTE
echo "****************************************************************"
echo "***** COMANDO FINALIZADO COM SUCESSO ***** By: Nilsonlinux *****"
echo "****************************************************************"
cp /usr/share/applications/anydesk.desktop "/home/$USER/Desktop/"
echo
tempofinal=`date +%s`
